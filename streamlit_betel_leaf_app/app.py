...
with tabs[3]:
    st.header("About Us")
    st.markdown("""
    We are students from **Rajalakshmi Engineering College, Department of Mechatronics Engineering**, interested in ML.
    We learned how to train the model from scratch and deployed it using a Streamlit app.
    """)
